    ...
    168: function(t, n, i) {
        ...
        self.addEventListener("notificationclick", function(t) {
          ...
          if (
            (t &&
              t.notification &&
              t.notification.data &&
              t.notification.data.clickUrl &&
              (n = t.notification.data.clickUrl),
            i)
          )
            if (t.action) {
      ...
      var o = {
        broadcastNotificationAction: function(t, n) {
          (n.actionType = t),
            (n.actionTs = Date.now()),
            this.broadcast("notification." + t, n);
        },
